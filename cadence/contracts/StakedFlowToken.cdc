...
pub contract StakedFlowToken: FungibleToken {
    ...
    // Total supply of staked token in existence
    ...
    pub resource Vault: FungibleToken.Provider, FungibleToken.Receiver, FungibleToken.Balance {
        ...
        pub fun deposit(from: @FungibleToken.Vault) {
            let vault <- from as! @StakedFlowToken.Vault
        ...
        destroy() {
            StakedFlowToken.totalSupply = StakedFlowToken.totalSupply - self.balance
        }
    }
    ...
    //
    pub fun createEmptyVault(): @StakedFlowToken.Vault {
    ...
    pub resource Minter {
        ...
        //
        pub fun mintTokens(amount: UFix64): @StakedFlowToken.Vault {
            pre {
                amount > 0.0: "Amount minted must be greater than zero"
            }
            StakedFlowToken.totalSupply = StakedFlowToken.totalSupply + amount
    ...
    init() {
        self.AdminStoragePath = /storage/stakedFlowTokenAdmin
        self.MinterProxyPublicPath = /public/stakedFlowTokenMinterProxy
        self.MinterProxyStoragePath = /storage/stakedFlowTokenMinterProxy
